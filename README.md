...
Clone this [repository](https://github.com/enis-memic/Decode-Morse-Code-Ruby) to your desired folder.
...
- Clone this [repository](https://github.com/enis-memic/Decode-Morse-Code-Ruby) in your local machine with correct branch.
